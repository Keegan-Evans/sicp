...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BLDSHARED': 'x86_64-apple-darwin13.4.0-clang -bundle -undefined '
              ...
              '-Wl,-rpath,/home/keegan/repo/sicp/sicp_env/lib '
 ...
 'CFLAGS': '-fno-strict-aliasing -Wsign-compare -Wunreachable-code -DNDEBUG '
           ...
           '-fdebug-prefix-map=/home/keegan/repo/sicp/sicp_env=/usr/local/src/conda-prefix '
 ...
 'CONFIGURE_LDFLAGS': '-Wl,-pie -Wl,-headerpad_max_install_names '
                      ...
                      '-L/home/keegan/repo/sicp/sicp_env/lib '
                      '-flto -Wl,-export_dynamic',
 'CONFIG_ARGS': "'--prefix=/home/keegan/repo/sicp/sicp_env' "
 ...
 'LIBFFI_INCLUDEDIR': '/home/keegan/repo/sicp/sicp_env/include',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/home/keegan/repo/sicp/sicp_env/lib/pkgconfig',
 'LIBPL': '/home/keegan/repo/sicp/sicp_env/lib/python3.7/config-3.7m-darwin',
 ...
 'NO_AS_NEEDED': '',
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/home/keegan/repo/sicp/sicp_env/include',
 'OPENSSL_LDFLAGS': '-L/home/keegan/repo/sicp/sicp_env/lib',
